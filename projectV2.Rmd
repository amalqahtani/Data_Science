...
=======
>>>>>>> 057974276d311f62a399ecbf144d7696b6b13cf8
![](covid19.png)
...
#tr(disease3)
disease3$State<-as.factor(disease3$State)
str(disease3)
scalediris <- as.data.frame(scale(disease3[2:6], center = TRUE, scale = TRUE))
...
iris_training <- scalediris[iris_sample==1, 1:5]
iris_test <- scalediris[iris_sample==2, 1:5]
#Now we need to create our 'Y' variables or labels need to input into the KNN function
iris.trainLabels <- iris[iris_sample==1, 1]
iris.testLabels <- iris[iris_sample==2, 1]
