...
##Does any disease relate the death rate?

### correlation of each disease to the death rate.
```{r,disease,echo=F}
loadPkg("dplyr") 
disease<-data[,c(1,2,7,8,47,50,53,55,60,61,65,71,72)]
#str(disease)
names(disease)[5:13] <- c("sleep_hour","diabetes","heart_disease","obesity_age","smokers","adult_obesity","excessive_drink","liver_crude_mortality","liver_Total_death","")
