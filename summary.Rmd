...
```
For the linear model with death related to disease, I added the total cases as the correlation of death and total cases are autocorrelate. by the Principle Component Method, drawing the cross-validation line and compare the MSEP of the death to the significant disease. The nuber of components drops down when number of components reach to two, which means the pc1 and pc2 can highliy explain the model. This shows the reliable of the the model is good enough. 
