...
In addition, the data is not perfect enough to predict death rate since it is outdated. This data set's last update is from April and the death number has increased greatly since then until now. Also, there are lots of missing data, especially for the disease. Only around 20 states out of 51 have a full record of the disease history of patients. These reasons make the available analysis data drop down from 3000 rows to 1000 rows; after deleting the missing data because the COVID-19 disease is not a fatal disease and patients will fight the disease for a long time till death. Also, the death of COVID-19 is not complete, since many potential patients may have passed away due to COVID-19, but it could have been counted as death by the normal Flu. Finally, some important categories were not included in the analysis and data set, such as blood type.
